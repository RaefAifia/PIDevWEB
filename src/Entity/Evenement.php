 ...
 * Evenement
 *
 * @ORM\Table(name="evenement", indexes={@ORM\Index(name="fk_event_lieu", columns={"lieu_id"}), @ORM\Index(name="fk_artist_event", columns={"id_artiste"})})
 * @ORM\Entity
 */
class Evenement
{
     ...
     * @var int
     *
     * @ORM\Column(name="capacitÃ©", type="integer", nullable=false)
     */
    private $capacitã©;
    ...
    public function getCapacitã©(): ?int
    {
        return $this->capacitã©;
    }

    public function setCapacitã©(int $capacitã©): self
    {
        $this->capacitã© = $capacitã©;
