 ...
 * Reclamation
 *
 * @ORM\Table(name="reclamation", indexes={@ORM\Index(name="fk_userrec", columns={"user_id"}), @ORM\Index(name="fk_oeuvrec", columns={"oeuvrage_id"}), @ORM\Index(name="fk_eventrec", columns={"evenement_id"}), @ORM\Index(name="fk_forrec", columns={"formation_id"})})
 * @ORM\Entity
 */
class Reclamation
{
